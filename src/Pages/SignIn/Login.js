...
const SignIn = () => {
    ...
    return (
        ...
        <div className="hero" style={{ backgroundImage: `url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPWi24vRySUcEaj5xOHJBzb9mOXRVlBTLJkw&usqp=CAU` }}>
      ...
      <div className="card-body">
                    ...
                    <p className=' flex justify-center mb-5'>Create a new account
